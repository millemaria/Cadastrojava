...
class CadastroTest {
    ...
    @Test
    @DisplayName("Deveria lançar uma execeção ao tentar editar um elemento que não existe")
    ...
    @Test
    @DisplayName("Deveria lançar uma exceção ao tentar excluir um elementto que não existe")
